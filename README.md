...
## Notes
This dataset is synthetic and was created solely for academic and research purposes. While it reflects realistic patterns for the Malawian mobile market, it does not represent actual user data.  

Key considerations:  
- The dataset is generated using statistical distributions and fixed parameters, which may oversimplify real-world behavior.  
- Urban–rural engagement differences are modeled with fixed multipliers and may not capture nuanced variations.  
- Approximately 5% of feedback scores are intentionally missing to simulate incomplete survey responses.    
- Outliers are present by design to mimic realistic variability in mobile usage.  
This dataset is suitable for:  
- Statistical analysis and visualization exercises  
- Machine learning experiments (e.g., retention prediction, A/B testing)  
- Educational demonstrations of reproducible synthetic data generation  
